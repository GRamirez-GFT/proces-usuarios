                            ...
                            <tr>
                                <td align="center" valign="top" style="padding-bottom:40px;">
                                    <!-- BEGIN FOOTER // -->
                                    <table border="0" bgcolor="#EEEEEE" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                        <tr>
                                            <td align="center" valign="top">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px; line-height: normal;">
                            ...
                            <br>
                            <br>
                            <strong><?=Yii::t('base', 'For questions or technical support')?>:</strong><br>
                            contacto@proces.com.mx<br>
                            <br>
                        </td>
                    </tr>
                </tbody></table>
