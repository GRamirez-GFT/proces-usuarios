	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input id="searchInTable" type="text" placeholder="Buscar..." />') :
			  sSearchStr==="" ? '<input id="searchInTable" type="text" placeholder="Buscar..." />' : sSearchStr+' <input id="searchInTable" type="text" placeholder="Buscar..." />';
